...
第4章では年次データに基づく長期的な構造変化を分析したが、実際の市場参加者にとっては、より短い時間軸での変動を捉えることが重要である。本章では2022年から2025年にかけての月次データを用い、MCI座標の短期的な動態を分析する。
...
オレンジの点線で示された年境界において、MCI座標が急激にジャンプしている。これは為替レートの実際の変動ではなく、PPP基準値の年次更新によるものである。

特に顕著なのは：
- **2023年1月**: m[TRY]が約-0.75から-0.45へ急上昇（+0.30）
- **2024年1月**: m[TRY]が約-0.71から-0.43へ急上昇（+0.28）

これらのジャンプは、トルコの高インフレによりPPP値が大幅に修正されたことを反映している。
