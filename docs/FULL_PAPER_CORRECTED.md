...
m[TRY]は-0.60付近（2022年初）から-0.47付近（2025年11月）へ、約3年かけて段階的に上昇している。m[JPY]は+0.19付近（2022年初）から-0.01付近（2025年11月）へ継続的に低下し、m[USD]は+0.41〜+0.60の範囲で推移、2025年11月時点で+0.49である。
...
- **JPY最大下落（2022年4月、-0.039）**: FOMCのQT加速合意とCPI 8.5%発表により米長期金利が急騰（2.4%→3.0%）。日米金利差の急拡大による円安圧力が生じた時期。
...
2023年以降の月次データから観察される傾向は以下である。USDは2023年の+0.597をピークに緩やかに低下し、2025年11月時点で+0.487。JPYは2022年の+0.197から継続的に低下し、2025年11月時点でほぼ中立（-0.015）。TRYは2023年7月の-0.766（底）から上昇傾向で、2025年11月時点で-0.472である。
