...
def main():
    ...
    with open("monthly_exchange_rates_2022_2025.csv", "r") as f:
    ...
    # Write to CSV
    with open("monthly_mci_interpolated_ppp_2022_2025.csv", "w", newline="") as f:
    ...
    print("=" * 60)
    print("✓ monthly_mci_interpolated_ppp_2022_2025.csv has been recalculated!")
    print("=" * 60)
